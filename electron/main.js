...
function prepareStableUserDataPath() {
  ...
  const stableDir = path.join(appData, 'CINF_Mining_Engineering')
  ...
  for (const folderName of ['CINF_Mining_Engineering', 'CINF采矿工程计算软件']) {
...
const APP_SPLASH_TAGLINE = '面向矿山工程建设与生产管理，提供采切计算、工程分析和成果整理等专业支持，帮助用户规范记录参数、复核结果并形成可追溯的技术资料。'
