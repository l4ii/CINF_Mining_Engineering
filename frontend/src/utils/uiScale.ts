...
export const UI_SCALE_STORAGE_KEY = 'cinf-mining:ui-scale'
...
export function applyUiScale(percent: number): number {
  ...
  if (typeof document !== 'undefined') {
    ...
    document.body.style.setProperty('zoom', String(clamped / 100))
  }
  if (typeof window !== 'undefined') {
    ...
    window.dispatchEvent(new CustomEvent('cinf-mining:ui-scale-changed', { detail: { percent: clamped } }))
  }
  return clamped
}
